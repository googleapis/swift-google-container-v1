...
Add `swift-google-container-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-container-v1.git --from 0.1.0
```

Then add `GoogleCloudContainerV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudContainerV1 <target-name> --package swift-google-container-v1
```
