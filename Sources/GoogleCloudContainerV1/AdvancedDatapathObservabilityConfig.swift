  ...
  Sendable
{
  ...
  public enum RelayMode: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:RelayMode/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RelayMode/unknownIntValue(_:)).
