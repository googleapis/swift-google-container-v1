...
/// Auto-Monitoring.
public struct AutoMonitoringConfig: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(AutoMonitoringConfig.Scope.self, forKey: .scope) {
      self.scope = value
    }
