  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let minProvisionNodes = CodingKeys(stringValue: "minProvisionNodes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Int32.self, forKey: .minProvisionNodes) {
      self.minProvisionNodes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.minProvisionNodes, forKey: .minProvisionNodes)
