...
public struct CheckAutopilotCompatibilityRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.CheckAutopilotCompatibilityRequest"
  }
