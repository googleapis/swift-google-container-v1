...
public struct ClusterUpgradeInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let rollbackSafeUpgradeStatus = CodingKeys(stringValue: "rollbackSafeUpgradeStatus")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ClusterUpgradeInfo.AutoUpgradeStatus].self, forKey: .autoUpgradeStatus)
    {
      self.autoUpgradeStatus = value
    }
    if let value = try container.decodeIfPresent(
      [ClusterUpgradeInfo.AutoUpgradePausedReason].self, forKey: .pausedReason)
    {
    ...
    self.rollbackSafeUpgradeStatus = try container.decodeIfPresent(
      RollbackSafeUpgradeStatus.self, forKey: .rollbackSafeUpgradeStatus)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.rollbackSafeUpgradeStatus, forKey: .rollbackSafeUpgradeStatus)
