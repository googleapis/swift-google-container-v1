...
public struct ControlPlaneEgress: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ControlPlaneEgress.Mode.self, forKey: .mode) {
      self.mode = value
    }
