...
public struct DNSConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum Provider: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .platformDefault: return try container.encode("PLATFORM_DEFAULT")
      case .cloudDns: return try container.encode("CLOUD_DNS")
      case .kubeDns: return try container.encode("KUBE_DNS")
  ...
  public enum DNSScope: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .clusterScope: return try container.encode("CLUSTER_SCOPE")
      case .vpcScope: return try container.encode("VPC_SCOPE")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
