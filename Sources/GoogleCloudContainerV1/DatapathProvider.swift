...
public enum DatapathProvider: Codable, Equatable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .legacyDatapath: return 1
    case .advancedDatapath: return 2
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DATAPATH_PROVIDER_UNSPECIFIED"
    case .legacyDatapath: return "LEGACY_DATAPATH"
    case .advancedDatapath: return "ADVANCED_DATAPATH"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "LEGACY_DATAPATH": self = .legacyDatapath
    case "ADVANCED_DATAPATH": self = .advancedDatapath
  ...
  public init(intValue: Int) {
    ...
    case 1: self = .legacyDatapath
    case 2: self = .advancedDatapath
