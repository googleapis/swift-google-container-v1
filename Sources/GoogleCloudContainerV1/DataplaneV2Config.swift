  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let scalabilityMode = CodingKeys(stringValue: "scalabilityMode")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.scalabilityMode = try container.decodeIfPresent(
      DataplaneV2Config.ScalabilityMode.self, forKey: .scalabilityMode)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.scalabilityMode, forKey: .scalabilityMode)
