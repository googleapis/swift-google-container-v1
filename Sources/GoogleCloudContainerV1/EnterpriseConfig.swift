  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let desiredTier = CodingKeys(stringValue: "desiredTier")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      EnterpriseConfig.ClusterTier.self, forKey: .clusterTier)
    {
      self.clusterTier = value
    }
    if let value = try container.decodeIfPresent(
      EnterpriseConfig.ClusterTier.self, forKey: .desiredTier)
    {
      self.desiredTier = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.desiredTier, forKey: .desiredTier)
