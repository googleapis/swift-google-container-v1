  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataCacheCount = CodingKeys(stringValue: "dataCacheCount")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Int32.self, forKey: .dataCacheCount) {
      self.dataCacheCount = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dataCacheCount, forKey: .dataCacheCount)
