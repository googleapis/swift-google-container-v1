...
public struct EvictionGracePeriod: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `EvictionGracePeriod`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = EvictionGracePeriod().with { $0.memoryAvailable = ... }
  /// ```
