...
public struct GPUDirectConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gpuDirectStrategy = CodingKeys(stringValue: "gpuDirectStrategy")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.gpuDirectStrategy = try container.decodeIfPresent(
      GPUDirectConfig.GPUDirectStrategy.self, forKey: .gpuDirectStrategy)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.gpuDirectStrategy, forKey: .gpuDirectStrategy)
  ...
  public enum GPUDirectStrategy: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:GPUDirectStrategy/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:GPUDirectStrategy/unknownIntValue(_:)).
