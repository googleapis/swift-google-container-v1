...
/// Accelerators.
public struct GPUSharingConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public enum GPUSharingStrategy: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "GPU_SHARING_STRATEGY_UNSPECIFIED"
      case .timeSharing: return "TIME_SHARING"
      case .mps: return "MPS"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:GPUSharingStrategy/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "GPU_SHARING_STRATEGY_UNSPECIFIED": self = .unspecified
      case "TIME_SHARING": self = .timeSharing
      case "MPS": self = .mps
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:GPUSharingStrategy/unknownIntValue(_:)).
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.GPUSharingConfig"
  }
