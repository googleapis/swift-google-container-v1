...
public struct HighScaleCheckpointingConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `HighScaleCheckpointingConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = HighScaleCheckpointingConfig().with { $0.enabled = ... }
  /// ```
