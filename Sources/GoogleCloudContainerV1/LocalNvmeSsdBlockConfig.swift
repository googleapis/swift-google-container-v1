...
/// NVMe SSDs
public struct LocalNvmeSsdBlockConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = LocalNvmeSsdBlockConfig().with { $0.localSsdCount = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.LocalNvmeSsdBlockConfig"
  }
