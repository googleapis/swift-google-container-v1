...
public struct LoggingComponentConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [LoggingComponentConfig.Component].self, forKey: .enableComponents)
    {
  ...
  public enum Component: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .kcpSshd: return try container.encode("KCP_SSHD")
      case .kcpConnection: return try container.encode("KCP_CONNECTION")
      case .kcpHpa: return try container.encode("KCP_HPA")
      case .kcpVpa: return try container.encode("KCP_VPA")
