...
public struct LoggingVariantConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      LoggingVariantConfig.Variant.self, forKey: .variant)
    {
      self.variant = value
    }
  ...
  public enum Variant: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "VARIANT_UNSPECIFIED"
      case .`default`: return "DEFAULT"
      case .maxThroughput: return "MAX_THROUGHPUT"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:Variant/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "VARIANT_UNSPECIFIED": self = .unspecified
      case "DEFAULT": self = .`default`
      case "MAX_THROUGHPUT": self = .maxThroughput
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:Variant/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .`default`
      case 2: self = .maxThroughput
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.LoggingVariantConfig"
  }
