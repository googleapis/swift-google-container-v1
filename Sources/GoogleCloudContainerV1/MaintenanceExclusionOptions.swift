  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let endTimeBehavior = CodingKeys(stringValue: "endTimeBehavior")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      MaintenanceExclusionOptions.EndTimeBehavior.self, forKey: .endTimeBehavior)
    {
      self.endTimeBehavior = value
    }
