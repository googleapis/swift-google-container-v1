  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let enableCertificates = CodingKeys(stringValue: "enableCertificates")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.enableCertificates, forKey: .enableCertificates)
