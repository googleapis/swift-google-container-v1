...
public struct MonitoringComponentConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let enableComponents = CodingKeys(stringValue: "enableComponents")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [MonitoringComponentConfig.Component].self, forKey: .enableComponents)
    {
      self.enableComponents = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.enableComponents, forKey: .enableComponents)
  ...
  public enum Component: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .apiserver: return try container.encode("APISERVER")
      case .scheduler: return try container.encode("SCHEDULER")
      case .controllerManager: return try container.encode("CONTROLLER_MANAGER")
      case .storage: return try container.encode("STORAGE")
      case .hpa: return try container.encode("HPA")
      case .pod: return try container.encode("POD")
      case .daemonset: return try container.encode("DAEMONSET")
      case .deployment: return try container.encode("DEPLOYMENT")
      case .statefulset: return try container.encode("STATEFULSET")
      case .cadvisor: return try container.encode("CADVISOR")
      case .kubelet: return try container.encode("KUBELET")
      case .dcgm: return try container.encode("DCGM")
      case .jobset: return try container.encode("JOBSET")
