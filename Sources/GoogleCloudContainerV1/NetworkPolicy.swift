  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(NetworkPolicy.Provider.self, forKey: .provider) {
      self.provider = value
    }
  ...
  public enum Provider: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .calico: return try container.encode("CALICO")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.NetworkPolicy"
  }
