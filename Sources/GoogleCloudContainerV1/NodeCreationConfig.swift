...
public struct NodeCreationConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let nodeCreationMode = CodingKeys(stringValue: "nodeCreationMode")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      NodeCreationConfig.Mode.self, forKey: .nodeCreationMode)
    {
      self.nodeCreationMode = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.nodeCreationMode, forKey: .nodeCreationMode)
