  ...
  Sendable
{
  ...
  public enum LocationPolicy: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:LocationPolicy/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:LocationPolicy/unknownIntValue(_:)).
