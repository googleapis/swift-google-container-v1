  ...
  Sendable
{
  ...
  public enum Status: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .aborting: return try container.encode("ABORTING")
  ...
  public enum Type_: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .createCluster: return try container.encode("CREATE_CLUSTER")
      case .deleteCluster: return try container.encode("DELETE_CLUSTER")
      case .upgradeMaster: return try container.encode("UPGRADE_MASTER")
      case .upgradeNodes: return try container.encode("UPGRADE_NODES")
      case .repairCluster: return try container.encode("REPAIR_CLUSTER")
      case .updateCluster: return try container.encode("UPDATE_CLUSTER")
      case .createNodePool: return try container.encode("CREATE_NODE_POOL")
      case .deleteNodePool: return try container.encode("DELETE_NODE_POOL")
      case .setNodePoolManagement: return try container.encode("SET_NODE_POOL_MANAGEMENT")
      case .autoRepairNodes: return try container.encode("AUTO_REPAIR_NODES")
      case .autoUpgradeNodes: return try container.encode("AUTO_UPGRADE_NODES")
      case .setLabels: return try container.encode("SET_LABELS")
      case .setMasterAuth: return try container.encode("SET_MASTER_AUTH")
      case .setNodePoolSize: return try container.encode("SET_NODE_POOL_SIZE")
      case .setNetworkPolicy: return try container.encode("SET_NETWORK_POLICY")
      case .setMaintenancePolicy: return try container.encode("SET_MAINTENANCE_POLICY")
      case .resizeCluster: return try container.encode("RESIZE_CLUSTER")
      case .fleetFeatureUpgrade: return try container.encode("FLEET_FEATURE_UPGRADE")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
