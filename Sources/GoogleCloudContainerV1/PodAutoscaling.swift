...
public struct PodAutoscaling: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let hpaProfile = CodingKeys(stringValue: "hpaProfile")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.hpaProfile = try container.decodeIfPresent(
      PodAutoscaling.HPAProfile.self, forKey: .hpaProfile)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.hpaProfile, forKey: .hpaProfile)
  ...
  public enum HPAProfile: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "HPA_PROFILE_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:HPAProfile/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "HPA_PROFILE_UNSPECIFIED": self = .unspecified
      case "NONE": self = .`none`
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:HPAProfile/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("HPA_PROFILE_UNSPECIFIED")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.PodAutoscaling"
  }
