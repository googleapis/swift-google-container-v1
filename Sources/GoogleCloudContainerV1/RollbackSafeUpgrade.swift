  ...
  Sendable
{
  ...
  public var controlPlaneSoakDuration: GoogleWKT.Duration? = nil
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let controlPlaneSoakDuration = CodingKeys(stringValue: "controlPlaneSoakDuration")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.controlPlaneSoakDuration = try container.decodeIfPresent(
      GoogleWKT.Duration.self, forKey: .controlPlaneSoakDuration)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.controlPlaneSoakDuration, forKey: .controlPlaneSoakDuration)
