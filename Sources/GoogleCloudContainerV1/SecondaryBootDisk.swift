  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let diskImage = CodingKeys(stringValue: "diskImage")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(SecondaryBootDisk.Mode.self, forKey: .mode) {
      self.mode = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .diskImage) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.diskImage, forKey: .diskImage)
