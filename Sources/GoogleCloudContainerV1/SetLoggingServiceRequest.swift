...
public struct SetLoggingServiceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SetLoggingServiceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SetLoggingServiceRequest().with { $0.projectId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.SetLoggingServiceRequest"
  }
