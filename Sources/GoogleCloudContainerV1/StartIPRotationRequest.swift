...
public struct StartIPRotationRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var rotateCredentials: Swift.Bool = Swift.Bool()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `StartIPRotationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StartIPRotationRequest().with { $0.projectId = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let rotateCredentials = CodingKeys(stringValue: "rotateCredentials")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .rotateCredentials) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.rotateCredentials, forKey: .rotateCredentials)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.StartIPRotationRequest"
  }
