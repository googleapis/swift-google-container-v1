...
public struct TaintConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let architectureTaintBehavior = CodingKeys(stringValue: "architectureTaintBehavior")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.architectureTaintBehavior = try container.decodeIfPresent(
      TaintConfig.ArchitectureTaintBehavior.self, forKey: .architectureTaintBehavior)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.architectureTaintBehavior, forKey: .architectureTaintBehavior)
  ...
  public enum ArchitectureTaintBehavior: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ArchitectureTaintBehavior/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ArchitectureTaintBehavior/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("ARCHITECTURE_TAINT_BEHAVIOR_UNSPECIFIED")
      case .`none`: return try container.encode("NONE")
      case .arm: return try container.encode("ARM")
