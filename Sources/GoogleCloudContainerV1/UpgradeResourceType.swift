...
public enum UpgradeResourceType: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "UPGRADE_RESOURCE_TYPE_UNSPECIFIED"
    case .master: return "MASTER"
    case .nodePool: return "NODE_POOL"
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("UPGRADE_RESOURCE_TYPE_UNSPECIFIED")
    case .master: return try container.encode("MASTER")
    case .nodePool: return try container.encode("NODE_POOL")
