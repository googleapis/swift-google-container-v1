...
public struct WindowsNodeConfig: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      WindowsNodeConfig.OSVersion.self, forKey: .osVersion)
    {
  ...
  public enum OSVersion: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .ltsc2019: return 1
      case .ltsc2022: return 2
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "OS_VERSION_UNSPECIFIED"
      case .ltsc2019: return "OS_VERSION_LTSC2019"
      case .ltsc2022: return "OS_VERSION_LTSC2022"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:OSVersion/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "OS_VERSION_UNSPECIFIED": self = .unspecified
      case "OS_VERSION_LTSC2019": self = .ltsc2019
      case "OS_VERSION_LTSC2022": self = .ltsc2022
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:OSVersion/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .ltsc2019
      case 2: self = .ltsc2022
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.container.v1.WindowsNodeConfig"
  }
