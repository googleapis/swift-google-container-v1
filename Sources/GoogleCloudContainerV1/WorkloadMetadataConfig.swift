...
public struct WorkloadMetadataConfig: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(WorkloadMetadataConfig.Mode.self, forKey: .mode) {
      self.mode = value
    }
  ...
  public enum Mode: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .gceMetadata: return 1
      case .gkeMetadata: return 2
    ...
    public var stringValue: Swift.String? {
      ...
      case .gkeMetadata: return "GKE_METADATA"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "GKE_METADATA": self = .gkeMetadata
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .gceMetadata
      case 2: self = .gkeMetadata
