...
public struct CompleteIPRotationRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CompleteIPRotationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CompleteIPRotationRequest().with { $0.projectId = ... }
  /// ```
