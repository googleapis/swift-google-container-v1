...
public struct DeleteNodePoolRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteNodePoolRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteNodePoolRequest().with { $0.projectId = ... }
  /// ```
