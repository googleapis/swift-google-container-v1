...
public struct GetServerConfigRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public static var _anyTypeUrl: String {
    return "type.googleapis.com/google.container.v1.GetServerConfigRequest"
  }
