...
/// a cluster.
public struct SetLegacyAbacRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SetLegacyAbacRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SetLegacyAbacRequest().with { $0.projectId = ... }
  /// ```
